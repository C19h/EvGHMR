...
def prepare_event_frame_single(actions, cpu_id, data_dir, target_dir, num_partitions=4, h=1280, w=800, image_size=256):
    for action in actions:
        ...
        for fname in fnames:
            ...
            #     # plt.axis('off')
            # plt.savefig(f"./events_image.png", bbox_inches='tight')
            ...
            cv2.imwrite('%s/xtore_%i/%s/%s.png' % (target_dir, image_size, action, img_name),
...
if __name__ == '__main__':
    data_dir = '../data_event/data_event_raw'
    target_dir = '../data_event/data_event_out'
    # prepare_full_pic(data_dir, target_dir, image_size=512)
    prepare_event_frame(data_dir, target_dir, image_size=256, num_cpus=1)
